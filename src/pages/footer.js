    ...
    >
      <div className="flex  m-auto flex-col text-white">
        <div className="text-[150px] md:lg:text-[200px] 4k:text-[300px] 4k:leading-[300px] font-tusker text-primaryFont leading-[200px] md:lg:leading-[100px] p-8">
          <text className='text-yellow'>Let's</text> {scrambledText}
        </div>
        <button className="hover:bg-white md:lg:px-7 m-auto bg-yellow mt-5  md:lg:pt-2 md:lg:pb-3 pt-1 pb-2 px-4 4k:px-10 4k:pt-4 4k:pb-5 font-abril text-md md:lg:text-2xl 4k:text-4xl text-black border-4 border-black rounded-full">
          say hello!
        </button>
      ...
      <div className="flex font-abril text-3xl flex-row justify-start ">
          <div className='hover:text-yellow'><a href='https://github.com/shrutitaylor/' target="_blank" rel="noopener noreferrer"> Github . </a></div>
          <div className='hover:text-yellow'><a href='https://linkedin.com/in/shruti-ms/' target="_blank" rel="noopener noreferrer"> Linkedin .</a> </div>
          
        </div>
        <div className='justify-end font-sora text-right'>Portfolio made with love by Shruti.</div>
      </div>
    </div>
  );
};
