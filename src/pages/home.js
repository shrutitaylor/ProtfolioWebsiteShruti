    ...
    <div className="flex flex-row justify-between grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 text-white">
      ...
      <div>
        <div className="font-jack text-[70px] leading-[30px] md:lg:text-[100px] md:lg:leading-[50px] 2xl:text-[160px] 2xl:leading-[80px]">
          *{currentDate[0]} <span className="text-[40px] md:lg:text-[70px] 2xl:text-[120px]">{currentDate[1]}</span>
        </div>
      ...
      <div className="flex flex-col md:px-10 px-5 2xl:px-20">
        ...
        <div className="font-tuskerBold text-yellow text-[100px] leading-[100px] md:text-[100px] md:leading-[100px] lg:text-[150px] lg:leading-[120px] 2xl:text-[300px] 2xl:leading-[300px]">
          {scrambledDesigner}
          <span className="font-jack text-[50px] md:lg:text-[70px] 2xl:text-[100px] text-primaryFont">&</span>
        </div>
      ...
      <div className="flex bottom-1 md:bottom-10 right-0 justify-end mr-5 md:absolute sm:relative 2xl:mr-10">
        <button className="px-5 pt-2 pb-3 2xl:px-10 2xl:pt-4 2xl:pb-5 font-abril text-md md:text-2xl 2xl:text-4xl text-primaryFont border-2 border-primaryFont rounded-full">
          contact me
        </button>
      </div>
    </div>
